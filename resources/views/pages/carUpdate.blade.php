...
<center>
<form action="{{route('carUpdate')}}" class="form-group" method="post">
{{csrf_field()}}
<br>
    ...
    @enderror
    <br>
    <label class="text-white text-uppercase fw-bold" for="">Image url</label>
    <input type="text" class="form-control" name="image" value="{{$car->image}}">
    <!-- @error('image')
    <span class="text-white">{{$message}}</span>
    @enderror<br> -->
    <br>
